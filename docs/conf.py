...
latex_documents = [
    ("index", "dolphin.tex", "dolphin Documentation", "Anowar J. Shajib", "manual"),
]
...
man_pages = [("index", "dolphin", "dolphin Documentation", ["Anowar J. Shajib"], 1)]
